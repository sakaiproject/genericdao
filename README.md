...
Building this project (requires Java 21 or newer and Jakarta EE 9+ compatible stacks such as Spring 6.x and Hibernate 6.x):
Run `mvn clean install` from the root source directory of this project.
