...
Building this project and putting it in your repository (requires Java 21 or newer and Jakarta EE 9+ compatible stacks such as Spring 6.x and Hibernate 6.x):
