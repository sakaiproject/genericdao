 ...
 */
public abstract class AbstractTestCrazyGenericDao {

    protected static GeneralGenericDao genericDao; 

    public static CrazyTestObject gto1;
    public static CrazyTestObject gto2;
    public static CrazyTestObject gto3;
    public static CrazyTestObject gto4;
    public static CrazyTestObject gto5;
    public static CrazyTestObject gto6;
    ...
    public static void preloadGTOs(GenericDao dao) {
    ...
    public void testGetIdProperty() {
        assertEquals(6, genericDao.countAll(CrazyTestObject.class));
